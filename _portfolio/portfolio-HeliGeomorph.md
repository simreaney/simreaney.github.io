...
## Phase Two: May 2018
The second phase of the fieldwork took place in May 2018 and had two objectives: firstly, to collect detailed dGPS ground control points to enable the 3D model to be tested and aligned to the Nepal mapping grid. Second, the fieldwork will measure the current river flow and the cross sections to the summer flood extent at 20-30 locations along the river system. This information will be used to build local and detailed hydraulic models for the river flow and the flow estimates will then calibrate and test SCIMAP-Flood. The SCIMAP-Flood risk mapping approach will identify where in the catchment is most important to manage to reduce flooding by working with natural processes approaches.